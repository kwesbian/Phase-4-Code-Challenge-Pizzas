...
def get_restaurant(id):
    ...
    if restaurant:
        restaurant_pizzas = [rp.to_dict(only=("id", "pizza_id", "price")) for rp in restaurant.restaurant_pizzas]
        body = restaurant.to_dict(only=("address", "id", "name",))
        body['restaurant_pizzas'] = restaurant_pizzas
        status = 200
    else:
